...
class BukuController extends Controller
{
    ...
    public function store(StoreBukuRequest $request)
    {
        ...
        Alert::warning('Data telah ditambahkan', 'Anda akan dialihkan ke halaman utama.');
    ...
    public function update(UpdateBukuRequest $request, $id)
    {
        ...
        Alert::warning('Data sudah terupdate', 'Anda akan dialihkan ke halaman utama.');
        return redirect('/buku');
    ...
    public function destroy($id)
    {
        ...
        Buku::destroy($id);
        Alert::warning('Data sudah terhapus', 'Anda akan dialihkan ke halaman utama.');
        return redirect('/buku');
