            ...
            <div class="col">
                <form action="/buku" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select form-select-md mb-3 @error('kategori') is-invalid @enderror" id="kategori" name="kategori">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('sampul') is-invalid @enderror" type="file" id="sampul" name="sampul" onchange="previewImage()">
